 ...
 */
  ...
  const updateOnePaymentMethod = async (PaymentMethodID, PaymentMethodData) => {
    ...
    const paymentMethodUpdated = await PaymentMethodModel.findByPk(PaymentMethodID)
 ...
 */
  ...
  export { storepaymentMethods, getAllPaymentMethods, updateOnePaymentMethod, deletePaymentMethod }